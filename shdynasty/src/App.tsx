...
function App() {
  ...
  //setInput is how react knows about new text typed in
  ...
  return (
    <Box bg="green.300" minH="100vh" py={8}>
      <Container maxW="650px">
        <VStack gap={5} align="stretch">
          <Box bg="purple.300" p={6} borderRadius="2xl" boxShadow="md">
          ...
          <Box bg="purple.300" p={5} borderRadius="2xl" boxShadow="md">
            <VStack gap={3} align="stretch">
              ...
              // when the button is clicked, run handleYapClick function
            ...
            >
              <HStack align="start" gap={4}>
                ...
                <VStack align="stretch" gap={2} flex="1">
                  ...
                  <HStack gap={6} color="white" fontSize="sm" pt={2}>
