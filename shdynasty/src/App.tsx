import {
  ...
  Button,
  Input,
} from "@chakra-ui/react"; import { Avatar } from "@chakra-ui/react";
...
function App() {
return (
  <Box bg="purple.900" minH="100vh" py={8}>
    <Container maxW="650px">
      <VStack gap={5} align="stretch">
        <Box bg="purple.600" p={6} borderRadius="2xl" boxShadow="md">
          <Heading size="lg" color="white">
            SHYDYNASTY
          </Heading>
          <Text color="grey.900" mt={2}>
            A simple Twitter clone built with Vite and Chakra UI.
          </Text>
        </Box>
    
        <Box bg="gray.700" p={5} borderRadius="2xl" boxShadow="md">
